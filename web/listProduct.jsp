...
<script>
	$(function(){
		...
		$("input.addCartButton").click(function(){
			...
			var page = "/cart_war_exploded/addOrderItem";
			$.get(
					page,
					{"num":number,"pid":pid},
					function(result){
...
<table align='center' border='1' cellspacing='0'>
	...
	<c:forEach items="${products}" var="product" varStatus="st">
		<tr>
			...
			<td>数量<input pid="${product.id}" class="number" type="text" value="1" name="num">
	...
	<tr>
	<td colspan="4"><a href="/cart_war_exploded/listOrderItem">查看购物车</a></td>
	</tr>
